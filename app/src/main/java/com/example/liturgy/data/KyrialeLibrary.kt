...
Gló(h)ri(gh)a(h) Pa(h)tri,(h) et(h) Fí(h)li(h)o,(h) et(h) Spi(h)rí(h)tu(h)i(g) Sanc(gh)to.(h.) *(:) Sic(h)ut(h) e(h)rat(h) in(h) prin(h)cí(h)pi(h)o,(h) et(h) nunc,(h) et(g) sem(gh)per,(h.) (:) et(h) in(h) saé(h)cu(h)la(h) sae(h)cu(h)ló(h)rum.(g) A(h)men.(h.) (::)""",
    ...
    val vidiAquam = GregorianChantItem(
        ...
        part = "Asperges",
        mode = "VIII",
        gabc = """name: Vidi aquam;
office-part: Antiphona;
mode: 8;
book: Graduale Romanum, 1961, p. 2* & The Liber Usualis, 1961, p. 12;
transcriber: Andrew Hinkley;
commentary: Ezech 47: 1-2, 9; Ps 117: 1;
%%
(c3) VI(ef)di(fd) a(fh)quam(h) *(,) e(e)gre(f)di(h)én(hi)tem(i) de(i) tem(h!ij)plo,(i.) (;) a(h) la(ij)te(i)re(h) dex(hg)tro,(f!gh) al(g)le(e)lú(ef)ia :(e.) (:) et(f) om(ef)nes,(d) ad(fh) quos(h) per(h)vé(hi)nit(i) a(i)qua(h) i(h!ij)sta,(i.) (;) sal(h)vi(ij) fac(i)ti(h) sunt,(hg/f!gh) (,) et(g) di(e)cent,(ef) al(g)le(f)lú(e)ia,(d) al(ef)le(f)lú(e)ia.(e.) (::)
(z) <sp>V/</sp>. Con(e)fi(fe)té(eh)mi(h)ni(h) Dó(h)mi(h)no(h) quó(h)ni(h)am(h) bo(h)nus :(i.) *(:) quó(h)ni(h)am(h) in(h) saé(h)cu(h)lum(h) mi(h)se(h)ri(h)cór(g)di(h)a(f) e(e)jus.(e.) (::)""",
    ...
    val kyrieDeAngelis = GregorianChantItem(
        ...
        part = "Kyrie",
        mode = "V",
        gabc = """name: Kyrie VIII;
office-part: Kyriale;
mode: 5;
book: Graduale Romanum, 1961, p. 28* & The Liber Usualis, 1961, p. 37;
transcriber: Andrew Hinkley;
%%
(c3) KY(d)ri(ef)e(f!gh) * e(gf)lé(e)i(fg)son.(f.) <i>bis</i>(::)
...
(c4) SAnc(f)tus,(fg/hgh) * Sanc(fg/hgh)tus,(f.) (;) Sanc(f!gh)tus(h) Dó(g)mi(f)nus(ef) De(g)us(f) Sá(e)ba(d)oth.(c.) (:) Ple(f)ni(fe) sunt(d) cae(ef)li(f) et(f) ter(gh)ra(h.) (;) gló(g)ri(f)a(ef) tu(g)a.(f.) (:) Ho(f!gh)sán(hvGF)na(e) in(f) ex(g)cél(e)sis.(d.) (:) Be(f)ne(ef)díc(g)tus(f) qui(fe) ve(d)nit(c.) (;) in(e) nó(f)mi(g)ne(f) Dó(e)mi(d)ni.(c.) (:) Ho(f!gh)sán(hvGF)na(e) in(f) ex(g)cél(e)sis.(d.) (::)""",
    ...
    val agnusDeAngelis = GregorianChantItem(
        ...
        part = "Agnus Dei",
        mode = "VI",
        gabc = """name: Agnus Dei VIII;
office-part: Kyriale;
mode: 6;
book: Graduale Romanum, 1961, p. 31* & The Liber Usualis, 1961, p. 39;
transcriber: Andrew Hinkley;
%%
(c4) A(f)gnus(ghg) De(f)i,(e.) * qui(f) tol(gh)lis(h) pec(gf)cá(g)ta(fe) mun(d)di :(c.) (;) mi(f)se(fe)ré(d)re(ef) no(g)bis.(f.) (::)
...
office-part: Kyriale;
mode: 8;
book: Graduale Romanum, 1961, p. 4* & The Liber Usualis, 1961, p. 16;
transcriber: Andrew Hinkley;
%%
(c4) KY(g)ri(g)e(fvED) * e(ef)lé(g)i(f)son.(e.) <i>bis</i>(::)
...
office-part: Kyriale;
mode: 1;
book: Graduale Romanum, 1961, p. 37* & The Liber Usualis, 1961, p. 46;
transcriber: Andrew Hinkley;
%%
(c4) KY(d)ri(dfED)e(c) * e(cd)lé(f)i(e)son.(d.) <i>bis</i>(::)
...
office-part: Kyriale;
mode: 1;
book: Graduale Romanum, 1961, p. 32* & The Liber Usualis, 1961, p. 40;
transcriber: Andrew Hinkley;
%%
(c4) KY(df)ri(fe)e(d) * e(fvED)lé(c)i(d)son.(d.) <i>bis</i>(::)
...
office-part: Kyriale;
mode: 5;
book: Graduale Romanum, 1961, p. 64* & The Liber Usualis, 1961, p. 68;
transcriber: Andrew Hinkley;
%%
(c3) CRe(d)do(ef) in(f) u(e)num(f) De(g)um,(f.) *(::) Pa(f)trem(gh) om(h)ni(g)po(f)tén(g)tem,(f.) (;) fac(f)tó(ef)rem(d) cae(c)li(d) et(ef) ter(g)rae,(f.) (;) vi(f)si(e)bí(f)li(g)um(f) óm(e)ni(d)um,(c.) (;) et(e) in(f)vi(g)si(f)bí(e)li(d)um.(d.) (::)
