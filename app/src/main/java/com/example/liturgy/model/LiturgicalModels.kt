...
enum class LiturgicalColor(
    ...
    WHITE("Albus", "Blanc", 0xFFE0DFDB, 0xFF1C1B1F),
    RED("Ruber", "Rouge", 0xFFB71C1C, 0xFFFFFFFF),
    GREEN("Viridis", "Vert", 0xFF2E7D32, 0xFFFFFFFF),
    VIOLET("Violaceus", "Violet", 0xFF512DA8, 0xFFFFFFFF),
    ROSE("Rosaceus", "Rose", 0xFFD81B60, 0xFFFFFFFF),
    BLACK("Niger", "Noir", 0xFF212121, 0xFFFFFFFF);
